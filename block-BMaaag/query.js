...
db.himalayas.insert({name : "Dhauladhar Range" , height : '4000 mrts'})
db.find.pretty()

// - insert multiple document using insertMany command
db.mountain.insertMany([{name : "Mountain Everest" , height : '8848 mrts'},{name : "Nanda Devi" , height : '7000 mtrs'}])
